...
| 075 | 2026-07-05 | WKH-SEC-03 | Cerrar cross-read `authenticated` de earnings/PII de creators con RLS Postgres-level | security | QUALITY | in progress | fix/075-wkh-sec-03-creator-earnings-rls ([work-item.md](075-wkh-sec-03-creator-earnings-rls/work-item.md)) |
