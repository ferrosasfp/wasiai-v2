...
interface paths {
    ...
    '/v2/curators': {
        ...
        /** @description Retrieves a complete list of available vault curators that can be used for filtering and organizing vault data */
        get: {
            parameters: {
                query?: never;
                header?: never;
                    ...
                    content: {
                        'application/json': {
                            ...
                            data: {
                                ...
                                /** @description URL to lend the asset */
                                lendUrl?: string;
...
declare class VaultsSdk {
    ...
    getRewardsTransactionsContext(params: Params<'/v2/transactions/rewards/context/{userAddress}'>): Promise<{
        claimable: {
            mainnet: {
                claimId: string;
                asset: {
    ...
    getRewardsClaimActions(params: Params<'/v2/transactions/rewards/claim/{userAddress}'>): Promise<{
        mainnet: {
            currentActionIndex: number;
            actions: {
                name: string;
    ...
    getUserVaultTotalReturns(params: Params<'/v2/portfolio/total-returns/{userAddress}/{network}/{vaultAddress}'>): Promise<{
        address: string;
        assetCaip: string;
        name: string;
        symbol: string;
