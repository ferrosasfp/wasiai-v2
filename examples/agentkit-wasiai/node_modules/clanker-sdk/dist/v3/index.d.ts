...
declare class Clanker {
    ...
    claimRewardsSimulate(token: `0x${string}`, account?: Account): Promise<(viem.SimulateContractReturnType<readonly [{
        ...
        readonly stateMutability: "view";
        readonly type: "function";
    }], "renounceOwnership" | "transferOwnership" | "claimRewards" | "deployToken" | "deployTokenWithCustomTeamRewardRecipient" | "deployTokenZeroSupply" | "initialize" | "setAdmin" | "setDeprecated" | "updateLiquidityLocker" | "updateVault"> & {
        error?: undefined;
    }) | ({
        result?: undefined;
        request?: undefined;
