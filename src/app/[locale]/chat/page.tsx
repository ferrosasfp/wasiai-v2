      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
        <div className="max-w-md w-full text-center space-y-6">
          <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-avax-100">
            <MessageCircle size={32} className="text-avax-600" />
          </div>
          <h1 className="text-2xl font-bold text-gray-900">DeFi Chat</h1>
          <p className="text-gray-500">
            {t('signInRequired') ?? 'Sign in to access DeFi Chat and query agents with your API key.'}
          </p>
