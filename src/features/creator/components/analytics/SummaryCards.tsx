  ...
  return (
    <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-5">
      ...
      <div className="rounded-xl border border-gray-100 bg-white p-4 shadow-sm">
        <p className="text-xs text-gray-500 font-medium">Llamadas (24h)</p>
        <p className="mt-1 text-2xl font-bold text-gray-900">{calls24h.toLocaleString()}</p>
      </div>

      {/* Total Calls */}
      <div className="rounded-xl border border-gray-100 bg-white p-4 shadow-sm">
        <p className="text-xs text-gray-500 font-medium">Total llamadas</p>
        <p className="mt-1 text-2xl font-bold text-gray-900">{totalCalls.toLocaleString()}</p>
      </div>

      {/* Avg Latency */}
      <div className="rounded-xl border border-gray-100 bg-white p-4 shadow-sm">
        <p className="text-xs text-gray-500 font-medium">Latencia avg</p>
      ...
      {/* Uptime 24h */}
      <div className="rounded-xl border border-gray-100 bg-white p-4 shadow-sm">
        <p className="text-xs text-gray-500 font-medium">Uptime (24h)</p>
      ...
      <div className="rounded-xl border border-[#E84142]/20 bg-[#E84142]/5 p-4 shadow-sm">
        <p className="text-xs text-gray-500 font-medium">Earnings USDC</p>
